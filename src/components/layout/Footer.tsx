        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/docs/contact/" className="text-xs text-[#1e73be] hover:text-[#000000]">Contact</Link></li>
              <li><Link href="/docs/legal/privacy" className="text-xs text-[#1e73be] hover:text-[#000000]">Privacy Policy</Link></li>
              <li><Link href="/docs/legal/terms" className="text-xs text-[#1e73be] hover:text-[#000000]">Terms of Service</Link></li>
              <li><Link href="/docs/legal/disclaimer" className="text-xs text-[#1e73be] hover:text-[#000000]">Medical Disclaimer</Link></li>
              <li><Link href="/docs/legal/affiliate" className="text-xs text-[#1e73be] hover:text-[#000000]">Affiliate Disclosure</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/docs/about/" className="text-xs text-[#1e73be] hover:text-[#000000]">About</Link></li>
              <li><Link href="/docs/newsletter/" className="text-xs text-[#1e73be] hover:text-[#000000]">Newsletter</Link></li>
              <li><Link href="/docs/topics/" className="text-xs text-[#1e73be] hover:text-[#000000]">Health Topics</Link></li>
              <li><Link href="/docs/articles/" className="text-xs text-[#1e73be] hover:text-[#000000]">All Articles</Link></li>
              <li><Link href="/docs/search/" className="text-xs text-[#1e73be] hover:text-[#000000]">Search</Link></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl py-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <p className="text-xs text-[#575760]">
              &copy; Copyright {currentYear} <a href="/docs/" className="text-[#1e73be] hover:text-[#000000]">Unindoctrinated Nutrition Science</a>
            </p>
            <div className="flex gap-3">
              ...
              <a href="/docs/rss.xml" aria-label="RSS" className="text-[#575760] hover:text-[#222222] text-sm">RSS</a>
            </div>
          </div>
          <div className="mt-4">
